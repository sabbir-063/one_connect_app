...
import '../../controllers/donation/admin_donatenow.controller.dart';

class AdminDonateNowButtonScreen extends StatelessWidget {
  const AdminDonateNowButtonScreen({super.key});

  @override
  Widget build(BuildContext context) {
    final AdminDonateNowController controller = Get.put(AdminDonateNowController());
