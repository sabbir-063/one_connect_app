...
class OneTextFieldTheme {
  OneTextFieldTheme._();

  static InputDecorationTheme lightInputDecorationField = InputDecorationTheme(
    errorMaxLines: 3,
  ...
  static InputDecorationTheme darkInputDecorationField = InputDecorationTheme(
    errorMaxLines: 2,
    prefixIconColor: Colors.grey,
    suffixIconColor: Colors.grey,
